...
def add_download_to_ui(self, download_item_to_be_added, variaapp):
    ...
    download_thread = DownloadThread(self, download_item_url, actionrow, download_item_url, download_item_to_be_added, "regular", False, self.appconf["download_directory"])
